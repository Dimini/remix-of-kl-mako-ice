...
const Index = () => {
  ...
  const lowCarbonShare = electricityData ? 
    ...
    electricityData.electricityMix.other_renewables : 0;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            {electricityData && (
              <KPITile
                ...
                value={electricityData.electricityMix.nuclear.toFixed(0)}
                unit="%"
                description="Podiel jadrovej energie"
                tooltip="Percentuálny podiel jadrovej energie vo výrobe elektriny"
                trend="neutral"
                color="primary"
              />
            )}
